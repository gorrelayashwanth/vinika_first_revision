      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-2xl">
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight animate-fade-in">
              {content.heroHeadline}
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mt-6 leading-relaxed animate-fade-in" style={{ animationDelay: "0.1s" }}>
              {content.heroSubtext}
            </p>
            <div className="flex flex-wrap gap-4 mt-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
            {trustBadges.map((badge, i) => (
              <div key={i} className="flex flex-col items-center gap-2">
                <div className="bg-primary/15 rounded-full p-3 text-primary">{badge.icon}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6">
            {content.features.map((f, i) => (
              <span key={i} className="bg-accent-foreground/10 text-accent-foreground px-4 py-2 rounded-full text-sm font-medium backdrop-blur-sm">
                {f}
              </span>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {whyChooseUs.map((item, i) => (
              <div key={i} className="card-warm p-8 text-center group hover:shadow-warm-lg transition-all">
                <div className="bg-secondary rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4 text-primary group-hover:bg-primary/10 transition-colors">
                  {item.icon}
                </div>
